...
- `kbrd.layer{...}` — declare exclusive folder-local runtime layers of commands, hooks, eval functions, timers, async/HTTP work, and virtual columns; switch them with `l` and see the active layer in the header.
