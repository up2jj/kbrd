...
func NewRootCmd() *cobra.Command {
	...
	root.AddCommand(newInitCmd(), newCloneCmd(&flags), newIngestCmd(&flags), newServeCmd(), newCacheCmd(), newMCPCmd(), newRemindersCmd(), newExtensionCmd(), newCompanionCmd(), newPluginCmd())
	return root
}
