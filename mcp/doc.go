// Package mcp exposes kbrd's board operations and read-only board resources to
// MCP (Model Context Protocol) clients over a Streamable HTTP transport. It runs in-process alongside the
